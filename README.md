About dye-score-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dye-score-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/mozilla/dye-score/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6486&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dye-score-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dye-score` can be installed with `conda`:
...
```
mamba install dye-score
```

It is possible to list all of the versions of `dye-score` available on your platform with `conda`:
...
```
mamba search dye-score --channel conda-forge
```
...
mamba repoquery search dye-score --channel conda-forge

# List packages depending on `dye-score`:
mamba repoquery whoneeds dye-score --channel conda-forge

# List dependencies of `dye-score`:
mamba repoquery depends dye-score --channel conda-forge
```
